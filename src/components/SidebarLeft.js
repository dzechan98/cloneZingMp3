...
const activeStyle =
    "relative px-[21px] py-3 flex items-center gap-x-4 text-[#fff] text-[14px] font-semibold bg-[#3a3344] before:w-[3px] before:h-full before:bg-[#9b4de0] before:absolute before:left-[0]";
const notActiveStyle =
    "relative px-[21px] py-3 flex items-center gap-x-4 text-[#dadada] text-[14px] font-semibold hover:text-[#fff] group";

const SidebarLeft = () => {
    return (
        <div className="bg-[#231b2e] h-[100vh] w-[240px] fixed z-10">
            ...
            <div className="w-full h-[240px] overflow-y-scroll pb-4">
                ...
                <div className="my-5 px-[21px]">
                    <div className="p-3 bg-gradient-to-r from-[#614de6] to-[#ba60d7] rounded-lg flex items-center flex-col gap-3">
                        <p className="text-center text-[#fff] text-[12px] font-bold">
                            Nghe nhạc không quảng cáo cùng kho nhạc PREMIUM
                        </p>
                        <button className="text-[#32323d] px-3 py-[6px] bg-[#ffbd00] text-[12px] font-bold rounded-[999px]">
                            NÂNG CẤP TÀI KHOẢN
                        </button>
                    </div>
                </div>
